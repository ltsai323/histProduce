...
process.generalSet = cms.PSet(
    ...
    plotTitle  = cms.string('impact parameter from #pi in  #Lambda^{0}'),
...
process.plotSet = cms.VPSet(
    cms.PSet( NameInTree    = cms.string( 'fd180parSignalIPt_pion_inLam0' ),
              TitleName= cms.string( 'signal proton' ), # used in TLegend
              #ScaleFactor   = cms.double( 1./2592. ), # if -1 set, normalize automatically
              ScaleFactor   = cms.double( 1./85. ), # if -1 set, normalize automatically
    ...
    cms.PSet( NameInTree    = cms.string( 'fd180parBackgroundIPt_pion_inLam0' ),
              TitleName= cms.string( 'background' ), # used in TLegend
              #ScaleFactor   = cms.double( 1./29607. ),
              ScaleFactor   = cms.double( 1./1086. ),
              SetFill  = cms.bool( False ),
              LineWidth= cms.int32( 2 ),
