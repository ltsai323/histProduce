...
# usage :
#    /UpdateFormatTree.py -I ../data/treeContent_MC_fourDaughterI.asc -D ../data/treeContent_MC_fourDaughterD.asc -o MC_fourDaughter --forceWrite
...
templateCC = '''
# include "histProduce/histProduce/interface/formatTree{0}.h"
# include <stdio.h>
# include <stdlib.h>
