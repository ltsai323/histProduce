...
void formatTree_LbTknew::RegFormatTree(TTree* t)
{
    if ( t == nullptr )
    {
        printf("formatTree LbTknew:        error to get tree to register!\n");
        exit(1);
    }
...
void formatTree_LbTknew::LoadFormatSourceBranch(TTree* t)
{
    if ( t == nullptr )
    {
