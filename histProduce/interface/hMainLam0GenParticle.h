#ifndef __hMainLam0GenParticle_h__
#define __hMainLam0GenParticle_h__
...
class histMain_Lam0GenParticle : public histMain
{
public:
    histMain_Lam0GenParticle ( TFileDirectory* d);
